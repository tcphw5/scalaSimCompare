...
// This version of the program is specifically for testing the
// similarity comparison part of the process.
// Only one of the 10k, 25k, 50k ect files will be used
// all other files are extras
...
object SimpleApp {
  def main(args: Array[String]): Unit = {
    ...
    /*  START OF COMMENTING OUT FOR SIM TESTING
