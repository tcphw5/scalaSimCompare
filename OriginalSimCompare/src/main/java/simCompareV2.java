...
public class simCompareV2 {
  ...
  public static void main(String[] args) {
    ...
    */
    ...
    //example of input needed to run the sim compare.
    //the level given (2 in this example) is the only level calculated
    //so to calculate this similarity between p1 and p2
    //you would need to sum
    //simScorePair(p1,t1,p2,t2,1)
    //simScorePair(p1,t1,p2,t2,2)

    double[] p1= {5,3,3,2,3,1,5};
    double[] p2 = {3,4,2,1,4};
    double[] t1= {0,2,1,2.5,4,4,6,0};
    double[] t2 = {0,6,3,1,5,6,3.5,0};

    System.out.println(simScorePair(p1,t1,p2,t2,2));
  ...
  //if more locations are needed, add more if statements similar to below
